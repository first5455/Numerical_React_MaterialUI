  ...
  return (
    <div>
      ...
      <Card style={{backgroundColor:"#ff9100"}} className={classes.root}>
        <CardContent>
          <Typography variant="h4" align="center" color="textPrimary">Solution Techniques Menu</Typography>
          <Tabs variant="scrollable" scrollButtons="on" centered>
              ...
              <Tab label="Cholesky Decomposition" component={Link} to="/cholesky" />
              <Tab label="Jacobi Iteration" component={Link} to="/jacobi_iter" />
              <Tab label="Gauss_Seidel" component={Link} to="/gauss_seidel" />
              <Tab label="Conjugate Gradient" component={Link} to="/conjugate_gradient" />
            </Tabs>
        </CardContent>
      </Card>
      <Switch>
            <Route path="/cramer"> <Cramer /> </Route>
            <Route path="/gauss_elimination"> <GaussElimination /> </Route>
            <Route path="/gauss_jordan"> <GaussJordan /> </Route>
            <Route path="/matrix_inversion"> <MatrixInver /> </Route>
            <Route path="/lu"> <Lu /> </Route>
            <Route path="/cholesky"> <Cholesky /> </Route>
            <Route path="/jacobi_iter"> <JacobiIter /> </Route>
            <Route path="/gauss_seidel"> <GaussSeidel /> </Route>
            <Route path="/conjugate_gradient"> <ConjugateGradient /> </Route>
        </Switch>
      </BrowserRouter>
    </div>
  );
